...
const MENUITEMS = [
  ...
  { state: 'utiles', type: 'link', name: 'Informations utiles', icon: 'crop_list'},
  { state: 'zone1', type: 'link', name: 'Zone annonceurs Slider', icon: ''},
  { state: 'zone2', type: 'link', name: 'Zone annonceurs bannières', icon: ''},
  ...
  { state: 'bannersCategory', type: 'link', name: 'Zone bannières catégories', icon: ''},
  ...
  { state: 'inscritsNewsletter', type: 'link', name: 'Inscrits newsletter', icon: ''},
